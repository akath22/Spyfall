...
public class GUI extends JFrame {
	...
	public void createContents() {
		...
		//button to reassign roles...
		JButton ReassignButton = new JButton("reassign roles");
		...
		JButton guessButton = new JButton("guess the spy");
	...
	public void addplayerPanel(Player player) {
		...
		JLabel roleLabel = new JLabel("no role yet");
		roleLabel.setVisible(false);
		
		JButton roleButton = new JButton("click to reveal role");
